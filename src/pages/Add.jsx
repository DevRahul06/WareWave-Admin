  ...
  return (
    <>
      <div className="w-full text-center">
        <p className="text-3xl text-black">Add Product</p>
      </div>
      <hr className="m-2" />
      ...
      >
        ...
        <button
          className="w-48 text-base py-3 mt-4 bg-black text-white hover:bg-[#c586a5] hover:text-[#ffebf5] transition-all duration-300 ease-in-out"
          type="submit"
        >
          Add
        </button>
